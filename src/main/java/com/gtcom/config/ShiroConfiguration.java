...
//        filterChainDefinitionManager.put("/login", "authc,roles[admin]");
...
//        filterChainDefinitionManager.put("/user/edit/**", "authc,perms[user:edit]");//        这里为了测试，固定写死的值，也可以从数据库或其他配置中读取
        ...
        filterChainDefinitionManager.put("/login/login", "anon");
...
//        shiroFilterFactoryBean.setUnauthorizedUrl("/login/error");
    ...
    /**
     * DefaultAdvisorAutoProxyCreator，Spring的一个bean，由Advisor决定对哪些类的方法进行AOP代 理。
     */
    @Bean
